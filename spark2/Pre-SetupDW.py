...
#---------------------------------------------------
print("JOB STARTED...")
spark.sql(f"DROP DATABASE IF EXISTS {prefix}_CAR_DATA CASCADE")
...
##                 CREATE DATABASES
##---------------------------------------------------
spark.sql(f"CREATE DATABASE {prefix}_CAR_DATA")
...
#               POPULATE TABLES
#---------------------------------------------------
car_sales.write.mode("overwrite").saveAsTable(f'{prefix}_CAR_DATA.CAR_SALES', format="parquet")
car_installs.write.mode("overwrite").saveAsTable(f'{prefix}_CAR_DATA.CAR_INSTALLS', format="parquet")
factory_data.write.mode("overwrite").saveAsTable(f'{prefix}_CAR_DATA.EXPERIMENTAL_MOTORS', format="parquet")
customer_data.write.mode("overwrite").saveAsTable(f'{prefix}_CAR_DATA.CUSTOMER_DATA', format="parquet")
geo_data.write.mode("overwrite").saveAsTable(f'{prefix}_CAR_DATA.GEO_DATA_XREF', format="parquet")
